...
export  function Carta({Pokemon,PokemonSolitario,setPokemonSolitario}) {
   ...
   function handleOnclick(poke){
    ...
    return (
        ...
        <div className="row row-cols-1 row-cols-sm-1 row-cols-md-3 row-cols-lg-4 row-cols-xl-4 mx-auto ">
            {
                Pokemon.map((poke) => {
                    return (
                        <div key={poke.id} className="card  mb-4  bg-black bg-opacity-75 text-white  carta" onClick={()=>handleOnclick(poke)}>
